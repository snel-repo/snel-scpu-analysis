...
import logging
from lfads_tf2.tuples import SamplingOutput, ModSamplingOutput
...
def load_posterior_averages(model_dir,
    ...
    for ds in h5dict.keys():
        ...
        fields = SamplingOutput._fields if not mod else ModSamplingOutput._fields
        for field in fields:
            if merge_tv: 
        ...
        if merge_tv:
            if not mod:
                ...
                sampling_output[ds] = ModSamplingOutput(**output)
        else:
