...
# ---------- OPTIONS ----------
PROJECT_STR = f"aav_{run_type}"
DATASET_STR = f"lfads_NP_AAV6-2_ReaChR_184500_ALL_spikes_2"
RUN_TAG = datetime.now().strftime("%y%m%d") + f"_aav_{run_type}_PBT_{initials}"
